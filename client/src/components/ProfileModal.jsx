...
const ProfileModal = ({ setShowEdit }) => {
  ...
  // ✅ Updated: removed `e` here; form will handle preventDefault
  const handleSaveProfile = async () => {
    try {
      ...
      // ✅ Await dispatch to ensure toast works correctly
    ...
    <div className="fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50">
      <div className="max-w-2xl sm:py-6 mx-auto">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {/* ✅ Updated: onSubmit now async with toast.promise */}
          <form
            className="space-y-4"
            onSubmit={async (e) => {
              e.preventDefault();
              await toast.promise(handleSaveProfile(), {
                loading: 'Saving...',
